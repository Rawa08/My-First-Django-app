...
class TestViews(TestCase):
    ...
    def test_deit_page_for_item_that_dose_not_exist(self):
    ...
    def test_post_edit_an_item(self):
        ...
        response = self.client.post('/edit/{0}'.format(id), {'name':'A diffrent name'})
        item = get_object_or_404(Item, pk=id)
        self.assertEqual('A diffrent name', item.name)
